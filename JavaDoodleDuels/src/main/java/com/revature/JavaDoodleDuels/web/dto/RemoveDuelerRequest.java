...
public class RemoveDuelerRequest {

	private String duelerName;

	public RemoveDuelerRequest() {
		super();
	}

	public RemoveDuelerRequest(String duelerName) {
		super();
	...
	public String toString() {
		return "RemoveDuelerRequest [duelerName=" + duelerName + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RemoveDuelerRequest other = (RemoveDuelerRequest) obj;
