...
document.getElementById("basicDesc").innerHTML =
  "Deal " + Math.floor(fighter1Strength / 2) + " physical damage";
...
if (abl1Stat == "strength") {
  abl1Damage =
    Number(abl1Damage) + (fighter1Strength - abl1ScalingReq) * abl1Scaling;
} else if (abl1Stat == "dexterity") {
  abl1Damage =
    Number(abl1Damage) + (fighter1Dexterity - abl1ScalingReq) * abl1Scaling;
} else if (abl1Stat == "constitution") {
  abl1Damage =
    Number(abl1Damage) + (fighter1Constitution - abl1ScalingReq) * abl1Scaling;
} else if (abl1Stat == "wisdom") {
  abl1Damage =
    Number(abl1Damage) + (fighter1Wisdom - abl1ScalingReq) * abl1Scaling;
} else if (abl1Stat == "intelligence") {
  abl1Damage =
    Number(abl1Damage) + (fighter1Intelligence - abl1ScalingReq) * abl1Scaling;
} else if (abl1Stat == "charisma") {
  abl1Damage =
    Number(abl1Damage) + (fighter1Charisma - abl1ScalingReq) * abl1Scaling;
}
...
if (abl2Stat == "strength") {
  abl2Damage =
    Number(abl2Damage) + (fighter1Strength - abl2ScalingReq) * abl2Scaling;
} else if (abl2Stat == "dexterity") {
  abl2Damage =
    Number(abl2Damage) + (fighter1Dexterity - abl2ScalingReq) * abl2Scaling;
} else if (abl2Stat == "constitution") {
  abl2Damage =
    Number(abl2Damage) + (fighter1Constitution - abl2ScalingReq) * abl2Scaling;
} else if (abl2Stat == "wisdom") {
  abl2Damage =
    Number(abl2Damage) + (fighter1Wisdom - abl2ScalingReq) * abl2Scaling;
} else if (abl2Stat == "intelligence") {
  abl2Damage =
    Number(abl2Damage) + (fighter1Intelligence - abl2ScalingReq) * abl2Scaling;
} else if (abl2Stat == "charisma") {
  abl2Damage =
    Number(abl2Damage) + (fighter1Charisma - abl2ScalingReq) * abl2Scaling;
}
...
if (abl3Stat == "strength") {
  abl3Damage =
    Number(abl3Damage) + (fighter1Strength - abl3ScalingReq) * abl3Scaling;
} else if (abl3Stat == "dexterity") {
  abl3Damage =
    Number(abl3Damage) + (fighter1Dexterity - abl3ScalingReq) * abl3Scaling;
} else if (abl3Stat == "constitution") {
  abl3Damage =
    Number(abl3Damage) + (fighter1Constitution - abl3ScalingReq) * abl3Scaling;
} else if (abl3Stat == "wisdom") {
  abl3Damage =
    Number(abl3Damage) + (fighter1Wisdom - abl3ScalingReq) * abl3Scaling;
} else if (abl3Stat == "intelligence") {
  abl3Damage =
    Number(abl3Damage) + (fighter1Intelligence - abl3ScalingReq) * abl3Scaling;
} else if (abl3Stat == "charisma") {
  abl3Damage =
    Number(abl3Damage) + (fighter1Charisma - abl3ScalingReq) * abl3Scaling;
}
...
document.getElementById("fighter2").src =
  "https://cdn.discordapp.com/attachments/946784294473453628/948677957025677372/unknown.png";
...
if (fighter2abl1Stat == "strength") {
  fighter2abl1Damage =
    Number(fighter2abl1Damage) +
    (fighter2Strength - fighter2abl1ScalingReq) * fighter2abl1Scaling;
} else if (fighter2abl1Stat == "dexterity") {
  fighter2abl1Damage =
    Number(fighter2abl1Damage) +
    (fighter2Dexterity - fighter2abl1ScalingReq) * fighter2abl1Scaling;
} else if (fighter2abl1Stat == "constitution") {
  fighter2abl1Damage =
    Number(fighter2abl1Damage) +
    (fighter2Constitution - fighter2abl1ScalingReq) * fighter2abl1Scaling;
} else if (fighter2abl1Stat == "wisdom") {
  fighter2abl1Damage =
    Number(fighter2abl1Damage) +
    (fighter2Wisdom - fighter2abl1ScalingReq) * fighter2abl1Scaling;
} else if (fighter2abl1Stat == "intelligence") {
  fighter2abl1Damage =
    Number(fighter2abl1Damage) +
    (fighter2Intelligence - fighter2abl1ScalingReq) * fighter2abl1Scaling;
} else if (fighter2abl1Stat == "charisma") {
  fighter2abl1Damage =
    Number(fighter2abl1Damage) +
    (fighter2Charisma - fighter2abl1ScalingReq) * fighter2abl1Scaling;
}
...
if (fighter2abl2Stat == "strength") {
  fighter2abl2Damage =
    Number(fighter2abl2Damage) +
    (fighter2Strength - fighter2abl2ScalingReq) * fighter2abl2Scaling;
} else if (fighter2abl2Stat == "dexterity") {
  fighter2abl2Damage =
    Number(fighter2abl2Damage) +
    (fighter2Dexterity - fighter2abl2ScalingReq) * fighter2abl2Scaling;
} else if (fighter2abl2Stat == "constitution") {
  fighter2abl2Damage =
    Number(fighter2abl2Damage) +
    (fighter2Constitution - fighter2abl2ScalingReq) * fighter2abl2Scaling;
} else if (fighter2abl2Stat == "wisdom") {
  fighter2abl2Damage =
    Number(fighter2abl2Damage) +
    (fighter2Wisdom - fighter2abl2ScalingReq) * fighter2abl2Scaling;
} else if (fighter2abl2Stat == "intelligence") {
  fighter2abl2Damage =
    Number(fighter2abl2Damage) +
    (fighter2Intelligence - fighter2abl2ScalingReq) * fighter2abl2Scaling;
} else if (fighter2abl2Stat == "charisma") {
  fighter2abl2Damage =
    Number(fighter2abl2Damage) +
    (fighter2Charisma - fighter2abl2ScalingReq) * fighter2abl2Scaling;
}
...
if (fighter2abl3Stat == "strength") {
  fighter2abl3Damage =
    Number(fighter2abl3Damage) +
    (fighter2Strength - fighter2abl3ScalingReq) * fighter2abl3Scaling;
} else if (fighter2abl3Stat == "dexterity") {
  fighter2abl3Damage =
    Number(fighter2abl3Damage) +
    (fighter2Dexterity - fighter2abl3ScalingReq) * fighter2abl3Scaling;
} else if (fighter2abl3Stat == "constitution") {
  fighter2abl3Damage =
    Number(fighter2abl3Damage) +
    (fighter2Constitution - fighter2abl3ScalingReq) * fighter2abl3Scaling;
} else if (fighter2abl3Stat == "wisdom") {
  fighter2abl3Damage =
    Number(fighter2abl3Damage) +
    (fighter2Wisdom - fighter2abl3ScalingReq) * fighter2abl3Scaling;
} else if (fighter2abl3Stat == "intelligence") {
  fighter2abl3Damage =
    Number(fighter2abl3Damage) +
    (fighter2Intelligence - fighter2abl3ScalingReq) * fighter2abl3Scaling;
} else if (fighter2abl3Stat == "charisma") {
  fighter2abl3Damage =
    Number(fighter2abl3Damage) +
    (fighter2Charisma - fighter2abl3ScalingReq) * fighter2abl3Scaling;
}
...
function basicAttack() {
  ...
  if (curhp - Math.floor(fighter1Strength / 2) < 0) {
    ...
    document.getElementById("health2").innerHTML -= Math.floor(
      fighter1Strength / 2
    );
  }
  var redPer =
    (document.getElementById("health2").innerHTML /
      document.getElementById("maxHealth2").innerHTML) *
    100;
  var whitePer = 100 - redPer;
  console.log(redPer);
  document.getElementById("hp2").style.background =
    "linear-gradient(to right , red " + redPer + "%, white " + whitePer + "%)";
  document.getElementById("fighter2").classList.add("shake");
  setTimeout(function () {
    document.getElementById("fighter2").classList.remove("shake");
  }, 500);
}
...
function abl1() {
  ...
  if (curmana >= abl1ManaCost) {
    if (abl1healing == 1) {
      ...
      if (
        curhp + abl1Damage >
        document.getElementById("maxHealth1").innerHTML
      ) {
        ...
        document.getElementById("health1").innerHTML =
          Number(document.getElementById("health1").innerHTML) +
          Number(abl1Damage);
        document.getElementById("mana1").innerHTML -= abl1ManaCost;
      }
      var redPer =
      ...
      var bluePar =
        (document.getElementById("mana1").innerHTML /
          document.getElementById("maxMana1").innerHTML) *
        100;
      var whitePer = 100 - redPer;
      document.getElementById("hp1").style.background =
      ...
      document.getElementById("mp1").style.background =
      ...
      setTimeout(function () {
        document.getElementById("fighter1").classList.remove("shake");
      }, 500);
    } else {
      var curhp = Number(document.getElementById("health2").innerHTML);
